...
class CustomButton extends StatelessWidget {
  ...
  CustomButton(
      { this.givenHeight, this.givenWidth,this.buttonColor:mainColor, this.text:"",
        this.fontSize:2,this.textColor:CupertinoColors.white,
        this.onTapFunction,this.radius:10,this.fontWieght:FontWeight.normal});
  @override
